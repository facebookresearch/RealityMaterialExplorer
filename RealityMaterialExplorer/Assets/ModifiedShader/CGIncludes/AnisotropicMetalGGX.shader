...
*/
Shader "Anisotropic Metal Shader"
{
    Properties
    {
		...
		_ax ("Anisotropic Angle X", Range(0.0,1.0)) = 0.0
		_ay ("Anisotropic Angle Y", Range(0.0,1.0)) = 1.0
		_az ("Anisotropic Angle Z", Range(0.0,1.0)) = 0.0
		
		/*Added by Jamie*/
		_dr ("Diffuse Red", Range(0.0,5.0)) = 0.1
		_dg ("Diffuse Green", Range(0.0,5.0)) = 0.1
		_db ("Diffuse Blue", Range(0.0,5.0)) = 0.1
		_sr ("Specular Red", Range(0.0,5.0)) = 0.1
		_sg ("Specular Green", Range(0.0,5.0)) = 0.1
		_sb ("Diffuse Blue", Range(0.0,5.0)) = 0.1
		_RoughnessAlpha ("Roughness Alpha", Range(0.0001,1.0)) = 0.01
		_Anisotropic ("Anisotropic Scaler", Range(0.0001,1.0)) = 0.5
		...
		/*Heitz Fits*/
		[Toggle] _Heitz ("Heitz Fitting", Float) = 0
    ...
    CGINCLUDE
		#define UNITY_BRDF_PBS BRDF_AMGGX_Unity_PBS
